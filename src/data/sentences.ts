...
export const allSentences: Sentence[] = [
  ...
  { english: "A hot pot.", hebrew: "סיר חם.", words: ["a", "hot", "pot"] },
  ...
  { english: "The milk is in the cup.", hebrew: "החלב בכוס.", words: ["the", "milk", "is", "in", "cup"] },
  { english: "I got a map.", hebrew: "קיבלתי מפה.", words: ["i", "got", "a", "map"] },
